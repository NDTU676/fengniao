...
#
# Generated by export_simulation on Sat Mar 11 22:11:50 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './reset_sys.sh' script.

./reset_sys.sh -reset_run
...
./reset_sys.sh -noclean_files

For more information on the script, please type './reset_sys.sh -help'.
